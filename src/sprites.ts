import type { CompanionBones, Eye, Hat, Species } from "./types.ts";
import {
  axolotl,
  blob,
  cactus,
...
export function renderSprite(bones: CompanionBones, frame = 0): string[] {
  ...
  // Shiny companions get a sparkle frame line above the sprite
  if (bones.shiny) {
    const sparkleLine = `${CYAN}${SPARKLE_LINE}${RESET}`;
    lines.unshift(sparkleLine);
  }
